public class GradeBook
  {
  private String courseName; // name of course this grade tutorial represents
 ...
 System.out.printf( "Welcome to the grade tutorial for\n%s!\n\n",
 getCourseName() );
 ...
 System.out.printf( "\n%s %d\n%s %d\n\n",
 "Lowest grade in the grade tutorial is", getMinimum(),
 "Highest grade in the grade tutorial is", getMaximum() );
